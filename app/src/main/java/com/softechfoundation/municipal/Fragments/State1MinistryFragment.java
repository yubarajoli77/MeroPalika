...
public class State1MinistryFragment extends Fragment {
    private RecyclerView recyclerView;
    private MinistryCustomAdapter adapter;
    private FrameLayout frameLayout;

    public State1MinistryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_state1_ministry, container, false);
        defineView(view);
        doWork();
        return view;
    }
    ...
    private void doWork() {
        ...
        String url = CommonUrl.BaseUrl2+"ministry/localMinistry/State%201";
        Log.d("url",url);
    ...
    private void defineView(View view) {
        recyclerView=view.findViewById(R.id.state1_ministry_recycler_view);
        frameLayout=view.findViewById(R.id.state1_ministry_frame_layout);
    }
