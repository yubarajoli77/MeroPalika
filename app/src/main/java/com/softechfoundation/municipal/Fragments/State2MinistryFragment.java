...
public class State2MinistryFragment extends Fragment {
    private RecyclerView recyclerView;
    private MinistryCustomAdapter adapter;
    private FrameLayout frameLayout;

    public State2MinistryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_state2_ministry, container, false);
        defineView(view);
        doWork();
        return view;
    }
    ...
    private void doWork() {
        ...
        String url = CommonUrl.BaseUrl2+"ministry/localMinistry/State%202";
    ...
    private void defineView(View view) {
        recyclerView=view.findViewById(R.id.state2_ministry_recycler_view);
        frameLayout=view.findViewById(R.id.state2_ministry_frame_layout);
    }
