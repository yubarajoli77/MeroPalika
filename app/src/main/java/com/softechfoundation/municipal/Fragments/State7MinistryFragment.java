...
public class State7MinistryFragment extends Fragment {
    private RecyclerView recyclerView;
    private MinistryCustomAdapter adapter;
    private FrameLayout frameLayout;

    public State7MinistryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_state7_ministry, container, false);
        defineView(view);
        doWork();
        return view;
    }
    ...
    private void doWork() {
        ...
        String url = CommonUrl.BaseUrl2+"ministry/localMinistry/State%207";
    ...
    private void defineView(View view) {
        recyclerView=view.findViewById(R.id.state7_ministry_recycler_view);
        frameLayout=view.findViewById(R.id.state7_ministry_frame_layout);
    }
