...
public class State6MinistryFragment extends Fragment {
    private RecyclerView recyclerView;
    private MinistryCustomAdapter adapter;
    private FrameLayout frameLayout;

    public State6MinistryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_state6_ministry, container, false);
        defineView(view);
        doWork();
        return view;
    }
    ...
    private void doWork() {
        ...
        String url = CommonUrl.BaseUrl2+"ministry/localMinistry/State%206";
    ...
    private void defineView(View view) {
        recyclerView=view.findViewById(R.id.state6_ministry_recycler_view);
        frameLayout=view.findViewById(R.id.state6_ministry_frame_layout);
    }
