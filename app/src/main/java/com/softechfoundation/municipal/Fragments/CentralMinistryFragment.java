 ...
 */
public class CentralMinistryFragment extends Fragment {
    private RecyclerView recyclerView;
    private MinistryCustomAdapter adapter;
    private FrameLayout frameLayout;
    public CentralMinistryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_central_ministry, container, false);
        defineView(view);
        doWork();
        return view;
    }
    private void doWork() {
        ...
        String url = CommonUrl.BaseUrl2+"ministry";
    ...
    private void defineView(View view) {
        recyclerView=view.findViewById(R.id.central_ministry_recycler_view);
        frameLayout=view.findViewById(R.id.central_fragment_frame_layout);
    }
}
